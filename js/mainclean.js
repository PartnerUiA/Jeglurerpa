...
var GameState = {
	...
	create: function(){
		...
		var colorchooserTxt = game.add.text(colorchooser.x,colorchooser.y,"Få en\nfarge!");
		...
		var decktxt = game.add.text(game.world.centerX, game.world.centerY+game.world.centerY-50, "Tilfeldig kortstokk #1");
		decktxt.anchor.x = 0.5;
