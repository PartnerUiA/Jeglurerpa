...
<body>
	...
	<div class="section full-height height-auto-lg hide-over background-light-blue">
					...
					<div id="setup">
						<h5>Hvilken kortstokk ønsker du å bruke?</h5>
						<?php 
							include '../private/getDeck.php';
							echo "<select id='deck' title='deckchooser'>";
							for ($o = 0; $o < sizeof($res); $o++) {
								echo "<option>".$res[$o]['D_Name']."</option>";
							}

							echo "</select>";
						?>

						<h5>Hvor mange spillere er det?</h5>
						...
						<div id="player1input" class="player-input">
							<label>Spiller 1:</label><br><input class="plyname" type="text" id="player1name" title="Player name" maxlength="16" value="Spiller 1"/>
						</div>

						<div id="player2input" class="player-input">
							<label>Spiller 2:</label><br> <input class="plyname" type="text" id="player2name" title="Player name" maxlength="16" value="Spiller 2" />
						</div>

						<div id="player3input" class="player-input">
							<label>Spiller 3:</label><br> <input class="plyname" type="text" id="player3name" title="Player name" maxlength="16" value="Spiller 3" />
						</div>

						<div id="player4input" class="player-input" style="display: none">
							<label>Spiller 4:</label><br> <input class="plyname" type="text" id="player4name" title="Player name" maxlength="16" value="Spiller 4" />
						</div>

						<div id="player5input" class="player-input" style="display: none">
							<label>Spiller 5:</label><br> <input class="plyname" type="text" id="player5name" title="Player name" maxlength="16" value="Spiller 5" />
						</div>

						<div id="player6input" class="player-input" style="display: none">
							<label>Spiller 6:</label><br> <input class="plyname" type="text" id="player6name" title="Player name" maxlength="16" value="Spiller 6" />
						</div>

						<div id="player7input" class="player-input" style="display: none">
							<label>Spiller 7:</label><br> <input class="plyname" type="text" id="player7name" title="Player name" maxlength="16" value="Spiller 7" />
						</div>

						<div id="player8input" class="player-input" style="display: none">
							<label>Spiller 8:</label><br> <input class="plyname" type="text" id="player8name" title="Player name" maxlength="16" value="Spiller 8" />
						</div>
						<div id="player9input" class="player-input" style="display: none">
							<label>Spiller 9:</label><br> <input class="plyname" type="text" id="player9name" title="Player name" maxlength="16" value="Spiller 9" />
						</div>
						<br>
						<button class="btn btn-primary js-tilt __mPS2id" id="startGame">Start spillet</button>
						</div>
						<div id="phptest">
						<?php 
